...
class MouseButtonEvent : public Qd::Events::Event {
 ...
 protected:
  explicit MouseButtonEvent(Qd::Core::MouseCode mouseCode)
...
class MouseButtonPressedEvent : public MouseButtonEvent {
 public:
  explicit MouseButtonPressedEvent(Core::MouseCode mouseCode)
...
class MouseButtonReleasedEvent : public MouseButtonEvent {
 public:
  explicit MouseButtonReleasedEvent(Core::MouseCode mouseCode)
      : MouseButtonEvent(mouseCode) {}
