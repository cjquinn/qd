...
class KeyboardEvent : public Qd::Events::Event {
 public:
  [[nodiscard]] inline Qd::Core::KeyCode getKeyCode() const { return keyCode_; }
...
class KeyPressedEvent : public KeyboardEvent {
 public:
  explicit KeyPressedEvent(Core::KeyCode keyCode, bool isRepeat)
      : KeyboardEvent(keyCode), isRepeat_(isRepeat) {}

  [[nodiscard]] inline bool getIsRepeat() const { return isRepeat_; }
